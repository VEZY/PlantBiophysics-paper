...
md"""
## Fitting
Photosynthesis and stomatal conductance parameters are fitted using plantecophys for plantecophys and LeafGasExchange.jl packages, and with own fitting module for PlantBiophysics.jl.
"""
...
Here we set wind velocity to 20 m/s (the Licor6400 chamber is well ventilated) and the characteristic length to the square root of the chamber area in $m^2$.
"""

# ╔═╡ 2c7870e2-1601-4c5a-adbf-200d8ae66c09
begin
	if simulated
...
# ╔═╡ 4e9068e2-3bc4-4fe3-92d2-3241f15b259b
md"### With PlantBiophysics.jl"
...
Plotting $E$, $A_s$, $T_l$ and $G_s$ using Makie.
"""

# ╔═╡ b80a65bf-d754-4f66-85d1-fda258ee2228
begin
...
# ╔═╡ 0620028a-5c1a-43ff-a0e1-abdbfabe313b
begin
	########################################################################
	# Transpiration 
...
# ╔═╡ 3a477693-a953-475e-8731-a14a24966ba1
begin
	########################################################################
	# Leaf temperature
...
# ╔═╡ 01d0b519-b7b1-4f36-a322-40e4ddbbcfb1
begin
	########################################################################
...
# ╔═╡ bbf15f8a-e954-47aa-8944-7b70edb824d7
fig
...
[[deps.Cropbox]]
deps = ["BlackBoxOptim", "CSV", "Cairo", "Crayons", "DataFrames", "DataStructures", "Dates", "Distributions", "FileIO", "Gadfly", "Graphviz_jll", "Highlights", "ImageMagick", "Interact", "Interpolations", "LightGraphs", "MacroTools", "Markdown", "PolynomialRoots", "ProgressMeter", "QuadGK", "REPL", "Random", "Setfield", "StatsBase", "SymPy", "TimeZones", "TypedTables", "UnicodePlots", "Unitful"]
git-tree-sha1 = "b8d0abcb8a6126e429a0c50c80904a6c5f943262"
...
[[deps.LeafGasExchange]]
deps = ["Cropbox"]
git-tree-sha1 = "1cb146a641a73c3a0fbca1e63672c69001571b84"
uuid = "eed59905-05f1-464e-afba-94c39a4505fd"
version = "0.1.0"
