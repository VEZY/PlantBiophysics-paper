...
begin
	...
	# Defining the variables we want to export:
	vars=Dict{String,Any}("Leaf" => (:Tₗ,))
	# Make the simulation:
	
    outs = run!(mtg_sim, models, weather, tracked_outputs=vars);
...
begin
    ...
    vars_bench=Dict{String,Any}("Leaf" => (:Tₗ,))
	times = @benchmark run!($mtg_sim, $models, $weather, tracked_outputs=$vars_bench)
end
...
DataFrames = "~1.7.0"
FLoops = "~0.2.2"
MultiScaleTreeGraph = "~0.14.4"
PlantBiophysics = "~0.16.0"
PlantGeom = "~0.13.0"
PlantMeteo = "~0.6.1"
PlantSimEngine = "~0.13.0"
PlutoUI = "~0.7.69"
"""
...
git-tree-sha1 = "8f565fa58659f0fd04ef86c9e75efab69dbea802"
...
git-tree-sha1 = "ccc2352622a48006b206901b0dafc8b0764607f8"
...
git-tree-sha1 = "844111ff6c32981739677eaf1544957d2d5c15f8"
...
git-tree-sha1 = "b49e4dd37fe89101c7248e2bd8d2a1b5ea258432"
uuid = "7ae8fcfa-76ad-4ec6-9ea7-5f8f5e2d6ec9"
version = "0.16.0"

[[deps.PlantGeom]]
deps = ["ColorSchemes", "Colors", "EzXML", "LinearAlgebra", "Makie", "Meshes", "MultiScaleTreeGraph", "Observables", "OrderedCollections", "RecipesBase", "Rotations", "StaticArrays", "Tables", "TransformsBase", "UUIDs", "Unitful"]
git-tree-sha1 = "06ef939037a8d2fcb66075d05161daef028746fb"
...
git-tree-sha1 = "3a5f92b2ca2deb6248b7142a9f0c72147f65e211"
uuid = "4630fe09-e0fb-4da5-a846-781cb73437b6"
version = "0.6.1"

[[deps.PlantSimEngine]]
deps = ["AbstractTrees", "CSV", "DataAPI", "DataFrames", "FLoops", "Markdown", "MultiScaleTreeGraph", "PlantMeteo", "SHA", "Statistics", "Tables", "Term"]
git-tree-sha1 = "02ba87dbfdabeebb7830e532c9e5637083e1945f"
