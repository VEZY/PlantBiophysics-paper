...
df = let
    ...
    rename!(df_, :PARi => :PPFD) # Rename Ttop to Tmin for consistency

    # Computing DateTime from Date and Time:
    transform!(df_, [:Date, :Time] => ((x, y) -> Date.(x, dateformat"Y/m/d") .+ y) => :Date)
...
# ╔═╡ c2ae5451-611f-431c-a1a7-5183becb4b0e
md"""
### PlantBiophysics
"""
...
begin
    ...
    Leaf_abs = 0.85 # default from plantecophys
...
manifest_format = "2.0"
project_hash = "5d45106a177dad63459f406a1198c4e15e2a0ddc"
