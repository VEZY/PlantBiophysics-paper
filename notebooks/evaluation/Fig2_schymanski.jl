...
params = read_dict("schymanski_et_al_2017/vdict_6a.txt")
...
results1_6a = CSV.read("schymanski_et_al_2017/results1_6a.csv", DataFrame)
...
begin
    ...
    ax = Axis(
        ...
        ylabel="Energy flux from leaf (W m⁻²)"
    )
