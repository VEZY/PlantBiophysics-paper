...
$(@bind tree Select(unique(df_Medlyn.Tree), default=3))
"""
...
save("figure_day.svg", fig, px_per_unit=3);
...
let
	...
	for var in [df.Dₗ => df_sim_forcedGs.Dlsim, df.Tₗ => df_sim_forcedGs.Tlsim, df.A => df_sim_forcedGs.Asim, df.Trmmol => df_sim_forcedGs.Esim]
		...
		for fn in [PlantSimEngine.RMSE, PlantSimEngine.NRMSE, PlantSimEngine.EF, Bias, nBias]
...
manifest_format = "2.0"
project_hash = "d1b774f58b5c2fa753622574a3152d0c0d0176c2"
...
git-tree-sha1 = "473529e40e14a14989e572e600fd7a8e194107c8"
