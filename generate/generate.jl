...
TITLE = "Support for PlantBiophysics article"

# ╔═╡ a0057e4c-0bcf-4970-8a2b-0412ad5af510
SUBTITLE = "Code for figure and tables reproduction"

# ╔═╡ 4be56e57-fea0-4fbe-9659-44bed594b1b2
INSTITUTION = "CIRAD"

# ╔═╡ c9f17f9f-766a-4137-92c5-f8173561a7bc
INSTITUTION_URL = "https://www.cirad.fr"
...
INSTRUCTORS = [
    (name="R. Vezy", url="https://www.remivezy.com/"),
    (name="S. Treillou", url="https://www.legos.omp.eu/author/simon-treillou/")
] |> instructors
...
begin
    ...
    PLUTO_DONE = GENERATED_NOTEBOOKS + 1
end
...
manifest_format = "2.0"
project_hash = "e596d9bed38dbc05af129e2939d99e73d3fb1602"
...
git-tree-sha1 = "6a6cdb6759a3f68e97104e7de582a601b5820bf1"
